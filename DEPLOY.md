...
420 tests pass (84 risk-score + 66 checks + 27 delta + 23 liquidity + 132 integration + 11 audit-report + 10 webhook + 10 jupiter + 5 response-signer + 18 api-keys + 16 policy-engine + 9 audit-db). Tests mock x402 and RPC — no network or wallet needed.
...
| `npm test` | `vitest run` | 420 tests across 12 files (mocked, no network) |
