...
export function createMcpServer(baseUrl: string = ""): McpServer {
  const server = new McpServer({
    ...
    version: "1.0.0",
    description:
      "Solana token safety scanner. Rug risk score 0-100 from pure on-chain analysis — mint/freeze authority, holder concentration, liquidity, LP locks, honeypot detection, Token-2022 extensions. Free lite check or $0.008 USDC full report via x402.",
